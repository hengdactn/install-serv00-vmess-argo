...
UUID=${1:-'323f5607-f006-4de1-ad9f-979ebcad7ccf'}
export UUID
echo "Using UUID: $UUID"
export NEZHA_SERVER=${NEZHA_SERVER:-''} 
export NEZHA_PORT=${NEZHA_PORT:-''}     
export NEZHA_KEY=${NEZHA_KEY:-''} 
export vmess_port=${vmess_port:-'58865'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'sever00_s0.hengda.dedyn.io'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiOTQ2ZmNiZTVjZGE5YjE4OThjZjEzYjYzZTU3MjQzM2UiLCJ0IjoiMWY4NjY4OTUtNjg5Yy00MGZlLWEzZTQtYjM2MGQ4NzE1YzBkIiwicyI6Ik1tUmxORGt3WTJJdFl6STFNaTAwTXpVNExUazJPV1F0TVRSalpXSmpZalExTmpRMSJ9'}
